...
export default function Home({ allTeachingData }) {
  ...
  let presentations = [
    {title: "Amortized Locally Decodable Codes for Insertions and Deletions", venue: ["ITC 2025"], id: "insDelaLDC", linksText: [], links: [], authors: "Jeremiah Blocki and Justin Zhang"},
