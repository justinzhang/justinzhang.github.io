...
export default function Home({ allTeachingData }) {
  ...
  let presentations = [{title: "Amortized Relaxed Locally Decodable Codes", venue: ["Preprint"], id: "arLDC", linksText: ["arXiv"], links: ["https://arxiv.org/abs/2609.16332"], authors: "Jeremiah Blocki and Justin Zhang"},
     ...
     <Layout home>
      ...
      {<section className={`${utilStyles.headingLg}`}> Teaching Assistant Materials
        ...
        <div className={utilStyles.blockshit}>&nbsp;</div>
          <ul className={utilStyles.list}>
            {allTeachingData
              .filter(({ semester }) => semester === "Fall 2025" || semester === "Fall 2026") //wtf fix this shit eventually, prob want a new directory here to all course material in reverse chron. order
